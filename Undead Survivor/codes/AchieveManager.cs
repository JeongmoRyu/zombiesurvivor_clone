...
public class AchieveManager : MonoBehaviour
{
    ...
    enum Achieve {UnlockFather, UnlockMother}
    ...
    void Init()
    {
        ...
        // PlayerPrefs.SetInt("UnlockFather", 0);
        // PlayerPrefs.SetInt("UnlockMother", 0);
    ...
    void CheckAchieve(Achieve achieve)
    {
        ...
        switch (achieve) {
            case Achieve.UnlockFather:
                isAchieve = GameManager.instance.kill >= 20;
                break;
            case Achieve.UnlockMother:
